...
const FeatureTutors = async () => {
  ...
  return (
    <div className="max-w-7xl mx-auto border py-12 px-3 rounded-lg border-black  mb-12 shadow-[0px_0px_15px_rgba(37,99,235,0.6)] 
  ">
      <div className="">
      ...
      <div className=" flex justify-center mt-12">
        <Link href={"/tutors"}>
          <button className="mt-6 bg-blue-600 shadow-lg shadow-blue-600 hover:bg-blue-700 text-white
