  ...
  return (
    <div className="max-w-sm rounded-2xl overflow-hidden shadow-lg bg-white p-4 hover:shadow-xl hover:shadow-blue-200 transition duration-300">
      <div className=" flex justify-between">
        <span className="rounded-full border border-[#f98900] px-3 py-1 text-xs text-[#f98900]">
          {tutor?.gradeLevel}
        </span>
      ...
      <div className="flex flex-col items-center gap-4 pb-2">
        ...
        <span className="rounded-full bg-[#f3f9ff] px-5 py-2 text-base font-semibold text-[#066ccb]">
          {tutor?.subjects}
        </span>
      </div>
      <hr />
      ...
      <div className="flex justify-between items-center mt-2">
        <span className="text-xl font-semibold text-[#f48750]">
          ${tutor?.price}/hr
        </span>
        <TooltipProvider>
          <Tooltip>
