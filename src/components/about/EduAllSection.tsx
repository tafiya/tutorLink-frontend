...
export default function EduAllSection() {
  return (
    <div className=" max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 items-center justify-between px-10 py-16 ">
      ...
      <div className="flex flex-col space-y-4 lg:w-1/2">
        ...
        <div className="flex space-x-6">
          <div className="bg-blue-600 text-white px-6 py-3 rounded-lg shadow-md text-center">
            <p className="text-2xl font-bold">16+</p>
            <p className="text-sm">Years of Experience</p>
          </div>
          <div className="bg-gray-900 text-white px-6 py-3 rounded-lg shadow-md text-center">
